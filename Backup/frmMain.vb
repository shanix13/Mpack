...
Public Class frmMain
    ...
    Dim currentversion As String = "v3.21"
...
#Region "Scanner 2"
    Private Sub DataReceviedHandler2(ByVal sender As Object, ByVal e As SerialDataReceivedEventArgs)
        ...
        If (Stage = 0 Or Stage = 10 Or Stage = 1 Or Stage = 2 Or Stage = 3) _
...
#End Region
    ...
    Private Sub SaveErrorText(ByVal value As String, ByVal FILE_NAME As String)
